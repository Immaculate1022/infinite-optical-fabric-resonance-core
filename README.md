...
### React Simulator
See `software/react-simulator/` — drop `IOFSimulator.jsx` into any React project.

## Key Documents

- [Materials Specification](docs/materials-specification.md)
- [Weaver’s Technical Primer](docs/weavers-technical-primer.md)
- [SRE Hardware & Governance](docs/sre-hardware-and-governance.md)
- [Executive Framing](docs/executive-framing.md)
- [Math Formalization](docs/math-formalization.md)

## Attribution

Conceptual architecture and collaborative development by **Gregory Scott Davis (Immaculate1022)**.  
Earlier materials were created across multiple AI stations and free accounts; this repository is the permanent open home.
